...
export default function ArchitectDashboard({ messages, onSendMessage }) {
  ...
  return (
    <div className="command-center" style={{ display: 'flex', flex: 1, color: '#fff', backgroundColor: '#1e1e1e' }}>
