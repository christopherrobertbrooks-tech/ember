...
export default function SettingsPanel({ isOpen, onClose, onMemoryWiped }) {
  const [settings, setSettings] = useState({ ollama_model: '', voice: '', sd_api_url: '', game_mode: false, complete_computer_control: false });
      ...
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="setting-group">
          ...
          <input 
            ...
            onChange={e => setSettings({...settings, sd_api_url: e.target.value})}
          />
        </div>
        ...
        <div className="setting-group" style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '12px' }}>
          <input
            ...
            style={{ width: '18px', height: '18px', cursor: 'pointer' }}
          />
          <label htmlFor="completeComputerControl" style={{ marginBottom: 0, cursor: 'pointer' }}>Enable Complete Computer Control</label>
        </div>
